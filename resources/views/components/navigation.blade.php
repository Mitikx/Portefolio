<nav class="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-4">
            ...
            <a href="#synthesis-table" class="hover:text-primary transition-colors">Tableau de Synthèse</a>
            <a href="#contact" class="hover:text-primary transition-colors">Contact</a>
        </div>

        <button @click="isMenuOpen = !isMenuOpen" class="md:hidden">
            <svg x-show="!isMenuOpen" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div x-show="isMenuOpen" x-cloak class="md:hidden bg-background/95 backdrop-blur-sm">
        ...
        <a href="#synthesis-table" class="block px-4 py-2 hover:bg-accent">Tableau de Synthèse</a>
